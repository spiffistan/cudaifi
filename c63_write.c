...
static void write_block(struct c63_common *cm, int16_t *in_data, struct macroblock *mv, uint32_t width, uint32_t height, uint32_t uoffset, uint32_t voffset, int16_t *prev_DC, int32_t cc, int channel)
{
    uint32_t i, j;
...
static void write_interleaved_data_MCU(struct c63_common *cm, int16_t *dct, struct macroblock *mv, uint32_t wi, uint32_t he, uint32_t h, uint32_t v, uint32_t x, uint32_t y, int16_t *prev_DC,
